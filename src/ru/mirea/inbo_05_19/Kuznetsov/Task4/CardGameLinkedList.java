package ru.mirea.inbo_05_19.Kuznetsov.Task4;
import java.util.*;
public class CardGameLinkedList {
    private LinkedList<Integer> cards1;
    private LinkedList<Integer> cards2;
    private int gameLength;

    public CardGameLinkedList() {
    ...
    public void TakeCards(int winner, int loser, LinkedList<Integer> cards) {
        cards.add(winner);
        cards.add(loser);
    }
    ...
    public static void main(String[] args) {
        CardGameLinkedList g = new CardGameLinkedList();
        g.Game();
    }
}
